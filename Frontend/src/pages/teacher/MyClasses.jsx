...
import { FolderOpen, Users, ArrowRight, Plus, X, BookOpen, MapPin, Hash, Trash2 } from 'lucide-react';
      ...
      <div className="flex h-screen bg-[#F0F0F0] overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 lg:p-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-8 pb-10">
            ...
            {loading ? (
              <div className="col-span-full text-center py-10 font-black uppercase text-xl">Loading Classes...</div>
            ) : classes.length === 0 ? (
              ...
              classes.map((cls, idx) => {
                ...
                return (
                  <motion.div 
                    ...
                    className="bg-white border-8 border-black p-6 cursor-pointer flex flex-col justify-between min-h-[250px]"
                    style={{ boxShadow: `8px 8px 0px #000` }}
                  >
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button 
                            ...
                            className="bg-[#FF0000] p-2 border-2 border-black text-white hover:bg-black transition-colors group"
                            title="Delete Class"
                          >
            ...
            {isModalOpen && (
              ...
              >
                <motion.div 
                  ...
                  exit={{ y: 50, opacity: 0 }}
                  className="bg-white border-8 border-black w-full max-w-2xl max-h-[90vh] overflow-y-auto"
                  style={{ boxShadow: '16px 16px 0px #000' }}
                >
                  <div className="flex justify-between items-center p-6 border-b-4 border-black bg-[#FFEB3B]">
                    ...
                    <button 
                      ...
                      className="bg-white border-4 border-black p-1 hover:bg-[#FF00FF] hover:text-white transition-colors"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="col-span-full">
                        ...
                        <input 
                          ...
                          className="w-full bg-[#f8f8f8] border-4 border-black px-4 py-3 text-lg font-bold focus:outline-none focus:bg-[#00FFFF] transition-colors"
