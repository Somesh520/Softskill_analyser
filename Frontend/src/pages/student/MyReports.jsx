      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-4xl font-black uppercase tracking-tight">My Reports & Activities</h1>
          </div>
          <button 
            onClick={fetchStudentActivities}
                ...
                >
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="flex flex-wrap items-center gap-3">
                      <span className="bg-[#FFEB3B] border-2 border-black font-black uppercase text-xs px-3 py-1">
                        {act.type}
                      </span>
                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex flex-wrap gap-2.5">
                          {Object.entries(act.criteriaMarks).map(([crit, mark]) => (
                            <div key={crit} className="bg-gray-100 border-2 border-black px-3 py-1.5 flex items-center gap-2 font-bold text-xs uppercase">
