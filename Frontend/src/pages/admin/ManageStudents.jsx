      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <input
            ...
            className="w-full bg-white border-8 border-black p-5 pl-16 text-xl font-black uppercase placeholder:text-gray-400 focus:outline-none focus:bg-[#FFFF00] transition-colors"
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-2xl font-black uppercase">Loading Students...</p>
          </div>
        ) : error ? (
          ...
          <>
            <p className="font-black uppercase text-lg mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              {filteredStudents.map((student, index) => (
                ...
                >
                  {/* Active badge */}
                  <div
                    className={`absolute top-4 right-4 px-3 py-1 font-black uppercase text-xs border-4 border-black ${student.isActive ? 'bg-[#00FF00]' : 'bg-[#FF0000] text-white'}`}
                  >
