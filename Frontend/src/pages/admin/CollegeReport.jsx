...
const CollegeReport = () => {
  ...
  // Radar chart data using performance distribution ranges
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-6 lg:p-8">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-2xl font-black uppercase">Loading Analytics...</p>
        </div>
      </div>
    );
  }
              ...
              <div className="divide-y-2 divide-black">
                {classPerformance.map((cls, idx) => (
                  <div key={idx} className="flex hover:bg-[#FFFACD] transition-all bg-white">
                    <div className="flex-1 min-w-32 p-4 border-r-2 border-gray-300 font-black text-lg">{cls.name}</div>
                    ...
                    <div className="w-28 min-w-28 p-4 border-r-2 border-gray-300 text-center font-bold">{cls.totalStudents}</div>
