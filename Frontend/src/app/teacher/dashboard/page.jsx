    ...
    <div className="flex flex-col flex-1 h-full w-full">
      <main className="flex-1 overflow-y-auto p-6 lg:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-black">
          <motion.div whileHover={{ y: -5 }} onClick={() => router.push('/teacher/assigned-students')} className="cursor-pointer">
            <NeoBrutalismCard 
              title="My Students" 
          ...
          <motion.div whileHover={{ y: -5 }} onClick={() => router.push('/teacher/create-activity')} className="cursor-pointer">
            <NeoBrutalismCard 
          ...
          <motion.div whileHover={{ y: -5 }} onClick={() => router.push('/teacher/reports')} className="cursor-pointer">
            <NeoBrutalismCard 
