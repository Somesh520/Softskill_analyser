...
import { Trophy, Medal, Award, Bot, Loader2, BrainCircuit, Sparkles, TrendingUp, AlertCircle } from 'lucide-react';
      ...
      <main className="flex-1 overflow-y-auto p-6 lg:p-10 relative">
        ...
        <div className="flex flex-col xl:flex-row gap-8">
          ...
          <div className="w-full xl:w-80 2xl:w-96 order-1 xl:order-2 shrink-0">
              ...
              {insightLoading ? (
                <div className="space-y-4">
                    <div className="flex items-center gap-3 text-primary font-semibold text-sm">
                        <Loader2 size={16} className="animate-spin" /> Analyzing performance...
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="pt-4 mt-4 border-t border-border/50 flex items-center justify-between">
                        <span className="text-xs font-semibold text-foreground/50 flex items-center gap-1"><Sparkles size={12}/> Powered by Groq</span>
                    </div>
                </div>
              )}
            </motion.div>

            {/* Quick Stats Widget (Optional, for visual balance) */}
            <motion.div
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
               <h4 className="font-bold text-primary mb-4 flex items-center gap-2"><TrendingUp size={18}/> Quick Stats</h4>
